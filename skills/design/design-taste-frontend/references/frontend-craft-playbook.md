# Frontend Craft Playbook

Use this reference after `SKILL.md` chooses the task mode and design direction. It preserves the full design-engineering rules, recipes, source notes, redesign protocol, block-library contract, and preflight checks.

## Contents

- [Brief inference](#0-brief-inference-read-the-room-before-anything-else)
- [Design dials](#1-the-three-dials-core-configuration)
- [Design-system routing](#2-brief--design-system-map)
- [Architecture and conventions](#3-default-architecture--conventions)
- [Design-engineering directives](#4-design-engineering-directives-bias-correction)
- [Motion recipes](#5-context-aware-proactivity)
- [Performance and accessibility](#6-performance--accessibility-guardrails)
- [Dark-mode protocol](#8-dark-mode-protocol)
- [AI-tell bans](#9-ai-tells-forbidden-patterns)
- [Pattern vocabulary](#10-reference-vocabulary-pattern-names-the-agent-should-know)
- [Redesign protocol](#11-redesign-protocol)
- [Block-library contract](#12-the-block-library-contract---implementations-land-here-iteratively)
- [Final preflight](#14-final-pre-flight-check)
- [Install commands and canonical sources](#appendices---real-source-backed-reference-material)
