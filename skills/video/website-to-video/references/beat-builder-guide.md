...
| `hyperframes/references/text-effects.md` (optional external catalog)                  | Named text animations from a separately installed text-effects skill; use HyperFrames animation rules when absent            | Beat has text animation                           |
