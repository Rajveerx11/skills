...
The bundled `full-reference-app.jsx`, CSS, Tailwind config, and HTML are one reference direction, resolved relative to this file. Treat the mockups as composition studies; adapt hierarchy, density, and sections to the brief rather than matching them mechanically.
